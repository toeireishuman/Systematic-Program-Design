...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname rocket-error-ms) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
(require spd-main/tags)
